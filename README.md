...
|테스트 번호|Retry|캐시 개수|데이터 개수|테스트케이스|동시접속수|예상 실패 요청 건수|실패 요청 건수|TPR|TPR(across all concurrent requests)|
|---|---|---|---|---|---|---|---|---|---|
|0|0번|0개|1개|2000개|200개|80개|1615개|11078.553.94ms|55.394ms|
|1|2번|0개|1개|2000개|200개|80개|183개|18076.302ms|90.382ms|
|2|2번|0개|1개|2000개|200개|80개|345개|19414.459ms|97.072ms|
|3|2번|0개|1개|2000개|200개|80개|156개|16067.715ms|80.339ms|
|4|2번|0개|1개|10000개|1000개|200개|실행 불가능|실행 불가능|실행 불가능|
|5|2번|3개|5개|10000개|1000개|??|21개|??|??|