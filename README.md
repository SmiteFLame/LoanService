...
|테스트 번호|시도 횟수|캐시 개수|데이터 개수|테스트케이스|동시접속수|Connection Pool 개수|예상 실패 요청|실패 건수|오차율|(실패)데이터베이스 시간 초과|(실패) CB 에러 수|비고|
|---|---|---|---|---|---|---|---|---|---|---|---|---|
|1|1번|0개|1개|100개|100개|200개|약 47개|88개||0개|10개|기본 테스트|
...
|4|1번|0개|1개|2000개|100개|200개|약 1416개|1833개||1666개|167개|동시접속 100개|
|5-1|1번|0개|1개|2000개|100개|Default(10개)|약 1416개|1829개||1667개|162개|커넥션 Pool 기본값인 경우|
|5-2|1번|0개|1개|2000개|100개|Default(10개)|약 1416개|1845개||1690개|155개|커넥션 Pool 기본값인 경우|
|6|1번|0개|1개|2000개|200개|200개|약 1416개|1905개||1821개|84개|동시접속 200개 변경|
|7-1|2번|0개|1개|2000개|200개|200개|약 1246개|1830개||1752개|78개|Retry 2번 추가|
|7-2|2번|0개|1개|2000개|200개|200개|약 1246개|1826개||1756개|70개|Retry 2번 추가|
...
|9-Cache동기화 O|2번|3개|5개|2000개 * 5|200개 * 5|Default(10개)|???|2개||0개|2개|캐시 동기화 기능 추가|
### 트랜잭션 일부 제거
|테스트 번호|시도 횟수|캐시 개수|데이터 개수|테스트케이스|동시접속수|Connection Pool 개수|예상 실패 요청|실패 건수|오차율|(실패)데이터베이스 시간 초과|(실패) CB 에러 수|비고|
|---|---|---|---|---|---|---|---|---|---|---|---|---|
|10|1번|0개|1개|2000개|200개|200개|약 1416개|1534개||???|???|트랜잭션 완전 제거|
|11|1번|0개|1개|2000개|200개|200개|약 1416개|1159개||365개|794개|저장 부분만 트랜잭션으로 변경|
|12|2번|0개|1개|2000개|200개|200개|약 1246개|641개||112개|529개|저장 부분만 트랜잭션으로 변경 및 Retry 2번|
|13|2번|0개|1개|2000개|200개|200개|약 1246개|1108개||248개|860개|저장 부분에 Lock있는 경우|
|14|2번|0개|1개|2000개|200개|Default(10개)|약 1416개|실험예정||실험예정|실험예정|트랜잭션 완전 제거,Connection Pool 기본값, Retry 2번|
...
|테스트 번호|시도 횟수|캐시 개수|데이터 개수|테스트케이스|동시접속수|Connection Pool 개수|예상 실패 요청|실패 건수|오차율|(실패)데이터베이스 시간 초과|(실패) CB 에러 수|비고|
|---|---|---|---|---|---|---|---|---|---|---|---|---|
|1|1번|0개|1개|100개|100개|200개|20개|16개||0개|16개|기본 테스트|
|2|1번|0개|1개|2000개|1개|400개|200개|401개||0개|401개|동시접속 X 변경| 
|3|1번|0개|1개|2000개|10개|400개|200개|387개||0개|387개|동시접속 10개 변경|
|4-1|1번|0개|1개|2000개|100개|200개|400개|362개||0개|362개|동시접속 100개|
|4-2|1번|0개|1개|2000개|100개|200개|400개|404개||0개|404개|동시접속 100개|
|5-1|1번|0개|1개|2000개|100개|Default(10개)|400개|541개||182개|360개|커넥션 Pool 기본값인 경우|
|5-2|1번|0개|1개|2000개|100개|Default(10개)|400개|408개||28개|380개|커넥션 Pool 기본값인 경우|
|5-3|1번|0개|1개|2000개|100개|Default(10개)|400개|471개||108개|363개|커넥션 Pool 기본값인 경우|
|6-1|1번|0개|1개|2000개|200개|200개|400개|436개||76개|360개|동시접속 200개 변경|
|6-2|1번|0개|1개|2000개|200개|200개|400개|698개||357개|341개|동시접속 200개 변경|
|7-1|2번|0개|1개|2000개|200개|200개|80개|168개||60개|108개|Retry 2번 추가|
|7-2|2번|0개|1개|2000개|200개|200개|80개|145개||54개|91개|Retry 2번 추가|
...
|9-Cache동기화 X|2번|3개|5개|2000개 * 5|200개 * 5|Default(10개)|???|9600개||0개|0개|캐시 동기화 기능 없는 경우|
|9-Cache동기화 O|2번|3개|5개|2000개 * 5|200개 * 5|Default(10개)|???|27개||0개|27개|캐시 동기화 기능 추가|
